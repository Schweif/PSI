...
v_flow_l_n = 3.2     # l/min volume flow through all parallel tubes, set to False to calculate volume current in l/min
...
P0 = 204            # J/s = W heating power
T_i = 20            # °C water inlet temperature

# Setup of the cooling channel
d = 0.006           # m diameter of water tube
l = 0.478           # m length of water tube in series e.g. if you have two parallel tube with a length l each, enter l
...
P_dens= 2093         #W/mrad² maximum power density of the beam
dist= 11.8           #m distance to source
tilt= 30            #° gracing angle of incident area, if direct use 90 °
distance = 0.030    #m thickness of the material between fluid and power in
